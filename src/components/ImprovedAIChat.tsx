  ...
  return (
    <>
      <motion.div
        ...
        className={`flex flex-col ${isFloating ? 'h-[600px] w-full max-w-md' : 'h-[calc(100vh-120px)] min-h-[600px]'} bg-white rounded-2xl shadow-xl border border-gray-200`}
      >
        {/* Clean Header */}
        ...
        <div className="p-4 bg-white border-t border-gray-200 rounded-b-2xl">
          {!isPro && messageCount >= 15 && (
            ...
            >
              <span>
                <span className="font-semibold">{20 - messageCount} mensaje{(20 - messageCount) !== 1 ? 's' : ''}</span> restante{(20 - messageCount) !== 1 ? 's' : ''} en modo gratuito
              </span>
              <button 
                onClick={() => setShowProModal(true)} 
          ...
          <form onSubmit={handleFormSubmit} className="flex gap-2">
            <div className="flex-1 relative">
              <input
                ...
                disabled={isLoading || (!isPro && messageCount >= 20)}
              />
              <button
                type="button"
            ...
            <button
              type="submit"
              disabled={!input.trim() || isLoading || (!isPro && messageCount >= 20)}
